...
public class FamilyMemberRelationship
{
    ...
    public Guid BaseFamilyMemberId { get; private set; }
    public Guid RelatedFamilyMemberId { get; private set; }
    public RelationshipType RelationshipType { get; private set; }
    public DateTime CreatedAt { get; private set; }
    public DateTime UpdatedAt { get; private set; }
    private FamilyMemberRelationship() { }
    private FamilyMemberRelationship(Guid familyMemberRelationshipId, Guid treeId, Guid familyMemberId, Guid relatedFamilyMemberId, RelationshipType relationshipType)
    {
        FamilyMemberRelationshipId = familyMemberRelationshipId;
        TreeId = treeId;
        BaseFamilyMemberId = familyMemberId;
        RelatedFamilyMemberId = relatedFamilyMemberId;
        RelationshipType = relationshipType;
        CreatedAt = UpdatedAt = DateTime.UtcNow;
    }
    public static Result<FamilyMemberRelationship> Create(Guid familyMemberRelationshipId, Guid treeId, Guid familyMemberId, Guid relatedFamilyMemberId, RelationshipType relationshipType)
    {
        ...
        var relationship = new FamilyMemberRelationship(familyMemberRelationshipId, treeId, familyMemberId, relatedFamilyMemberId, relationshipType);
